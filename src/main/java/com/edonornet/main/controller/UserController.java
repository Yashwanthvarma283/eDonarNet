...
public class UserController {
    ...
    UserController(UserService userService,LoginService loginService,DonorService donorService,RecipientService recipientService){
    ...
    public String validate_user(String email,String password,HttpSession session){
        ...
        if(user1==null){
            ...
            if(user==null){
                ...
                session.setAttribute("donations",donorService.findDonor(user.getEmail()));
                session.setAttribute("requests",recipientService.findRecipient(user.getEmail()));
